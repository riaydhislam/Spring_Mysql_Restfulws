 ...
 * 
 */
package uv.springmysqlrestfulws.controllers;
...
import uv.springmysqlrestfulws.model.UserRegistration;
import uv.springmysqlrestfulws.repositories.UserRegistrationRepositoryJPA;
import uv.springmysqlrestfulws.repositories.UserRegistrationRepositoryPSR;
import uv.springmysqlrestfulws.services.UserRegistrationServiceImpl;
...
public class UserRegistrationControllerPASR {
	...
	@RequestMapping(value = "/userRegistrations", method = RequestMethod.GET)
	 public HttpEntity<PagedResources<UserRegistration>> userRegistrations(Pageable pageable,PagedResourcesAssembler assembler) {
